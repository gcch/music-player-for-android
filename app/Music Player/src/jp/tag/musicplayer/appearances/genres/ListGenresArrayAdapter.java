...
public class ListGenresArrayAdapter extends ArrayAdapter<_Genre> implements SectionIndexer {
  ...
  public ListGenresArrayAdapter(Context context, List<_Genre> item) {
